# Contributing to AmoraDigitalRock

There are many ways to contribute to AmoraDigitalRock.

- Submit a feature request or bug, or add to the discussion on the [AmoraDigitalRock issue tracker][is]
- Submit a [Pull Request][pr] to improve AmoraDigitalRock.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to AmoraDigitalRock development and you don't have push access to the AmoraDigitalRock
...
When submitting a PR, make sure to add a `Cc: @AmoraDigitalRock/developers` comment to
notify AmoraDigitalRock developers of your awesome contributions. Based on the
...
- You do NOT have push access: A AmoraDigitalRock core developer will integrate your PR.
...
[pr]: https://github.com/LPSA-UFPA/AmoraDigitalRock/merge_requests
[is]: https://github.com/LPSA-UFPA/AmoraDigitalRock/issues
